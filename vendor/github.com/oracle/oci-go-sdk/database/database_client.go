...
func (client DatabaseClient) DeleteBackup(ctx context.Context, request DeleteBackupRequest, options ...common.RetryPolicyOption) (err error) {
...
func (client DatabaseClient) DeleteDbHome(ctx context.Context, request DeleteDbHomeRequest, options ...common.RetryPolicyOption) (err error) {
...
func (client DatabaseClient) TerminateDbSystem(ctx context.Context, request TerminateDbSystemRequest, options ...common.RetryPolicyOption) (err error) {
