...
func (client BlockstorageClient) DeleteBootVolume(ctx context.Context, request DeleteBootVolumeRequest, options ...common.RetryPolicyOption) (err error) {
...
func (client BlockstorageClient) DeleteVolume(ctx context.Context, request DeleteVolumeRequest, options ...common.RetryPolicyOption) (err error) {
...
func (client BlockstorageClient) DeleteVolumeBackup(ctx context.Context, request DeleteVolumeBackupRequest, options ...common.RetryPolicyOption) (err error) {
