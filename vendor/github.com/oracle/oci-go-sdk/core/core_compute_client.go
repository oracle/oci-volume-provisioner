...
func (client ComputeClient) AddImageShapeCompatibilityEntry(ctx context.Context, request AddImageShapeCompatibilityEntryRequest, options ...common.RetryPolicyOption) (response AddImageShapeCompatibilityEntryResponse, err error) {
...
func (client ComputeClient) AttachBootVolume(ctx context.Context, request AttachBootVolumeRequest, options ...common.RetryPolicyOption) (response AttachBootVolumeResponse, err error) {
...
func (client ComputeClient) AttachVnic(ctx context.Context, request AttachVnicRequest, options ...common.RetryPolicyOption) (response AttachVnicResponse, err error) {
...
func (client ComputeClient) AttachVolume(ctx context.Context, request AttachVolumeRequest, options ...common.RetryPolicyOption) (response AttachVolumeResponse, err error) {
...
func (client ComputeClient) CaptureConsoleHistory(ctx context.Context, request CaptureConsoleHistoryRequest, options ...common.RetryPolicyOption) (response CaptureConsoleHistoryResponse, err error) {
...
func (client ComputeClient) CreateImage(ctx context.Context, request CreateImageRequest, options ...common.RetryPolicyOption) (response CreateImageResponse, err error) {
...
func (client ComputeClient) CreateInstanceConsoleConnection(ctx context.Context, request CreateInstanceConsoleConnectionRequest, options ...common.RetryPolicyOption) (response CreateInstanceConsoleConnectionResponse, err error) {
...
func (client ComputeClient) DeleteConsoleHistory(ctx context.Context, request DeleteConsoleHistoryRequest, options ...common.RetryPolicyOption) (err error) {
...
func (client ComputeClient) DeleteImage(ctx context.Context, request DeleteImageRequest, options ...common.RetryPolicyOption) (err error) {
...
func (client ComputeClient) DeleteInstanceConsoleConnection(ctx context.Context, request DeleteInstanceConsoleConnectionRequest, options ...common.RetryPolicyOption) (err error) {
...
func (client ComputeClient) DetachBootVolume(ctx context.Context, request DetachBootVolumeRequest, options ...common.RetryPolicyOption) (err error) {
...
// will be dropped.
func (client ComputeClient) DetachVnic(ctx context.Context, request DetachVnicRequest, options ...common.RetryPolicyOption) (err error) {
...
// This is an asynchronous operation. The attachment's `lifecycleState` will change to DETACHING temporarily
// until the attachment is completely removed.
func (client ComputeClient) DetachVolume(ctx context.Context, request DetachVolumeRequest, options ...common.RetryPolicyOption) (err error) {
...
// See [Object Storage URLs]({{DOC_SERVER_URL}}/Content/Compute/Tasks/imageimportexport.htm#URLs) and [pre-authenticated requests]({{DOC_SERVER_URL}}/Content/Object/Tasks/managingaccess.htm#pre-auth)
// for constructing URLs for image import/export.
func (client ComputeClient) ExportImage(ctx context.Context, request ExportImageRequest, options ...common.RetryPolicyOption) (response ExportImageResponse, err error) {
...
func (client ComputeClient) GetBootVolumeAttachment(ctx context.Context, request GetBootVolumeAttachmentRequest, options ...common.RetryPolicyOption) (response GetBootVolumeAttachmentResponse, err error) {
...
func (client ComputeClient) GetConsoleHistory(ctx context.Context, request GetConsoleHistoryRequest, options ...common.RetryPolicyOption) (response GetConsoleHistoryResponse, err error) {
...
// See CaptureConsoleHistory
// for details about using the console history operations.
func (client ComputeClient) GetConsoleHistoryContent(ctx context.Context, request GetConsoleHistoryContentRequest, options ...common.RetryPolicyOption) (response GetConsoleHistoryContentResponse, err error) {
...
func (client ComputeClient) GetImage(ctx context.Context, request GetImageRequest, options ...common.RetryPolicyOption) (response GetImageResponse, err error) {
...
func (client ComputeClient) GetInstance(ctx context.Context, request GetInstanceRequest, options ...common.RetryPolicyOption) (response GetInstanceResponse, err error) {
...
func (client ComputeClient) GetInstanceConsoleConnection(ctx context.Context, request GetInstanceConsoleConnectionRequest, options ...common.RetryPolicyOption) (response GetInstanceConsoleConnectionResponse, err error) {
...
func (client ComputeClient) GetVnicAttachment(ctx context.Context, request GetVnicAttachmentRequest, options ...common.RetryPolicyOption) (response GetVnicAttachmentResponse, err error) {
...
func (client ComputeClient) GetVolumeAttachment(ctx context.Context, request GetVolumeAttachmentRequest, options ...common.RetryPolicyOption) (response GetVolumeAttachmentResponse, err error) {
...
func (client ComputeClient) GetWindowsInstanceInitialCredentials(ctx context.Context, request GetWindowsInstanceInitialCredentialsRequest, options ...common.RetryPolicyOption) (response GetWindowsInstanceInitialCredentialsResponse, err error) {
...
func (client ComputeClient) InstanceAction(ctx context.Context, request InstanceActionRequest, options ...common.RetryPolicyOption) (response InstanceActionResponse, err error) {
...
// [Virtual Network Interface Cards (VNICs)]({{DOC_SERVER_URL}}/Content/Network/Tasks/managingVNICs.htm).
func (client ComputeClient) LaunchInstance(ctx context.Context, request LaunchInstanceRequest, options ...common.RetryPolicyOption) (response LaunchInstanceResponse, err error) {
...
func (client ComputeClient) ListBootVolumeAttachments(ctx context.Context, request ListBootVolumeAttachmentsRequest, options ...common.RetryPolicyOption) (response ListBootVolumeAttachmentsResponse, err error) {
...
func (client ComputeClient) ListConsoleHistories(ctx context.Context, request ListConsoleHistoriesRequest, options ...common.RetryPolicyOption) (response ListConsoleHistoriesResponse, err error) {
...
func (client ComputeClient) ListImages(ctx context.Context, request ListImagesRequest, options ...common.RetryPolicyOption) (response ListImagesResponse, err error) {
...
func (client ComputeClient) ListInstanceConsoleConnections(ctx context.Context, request ListInstanceConsoleConnectionsRequest, options ...common.RetryPolicyOption) (response ListInstanceConsoleConnectionsResponse, err error) {
...
func (client ComputeClient) ListInstances(ctx context.Context, request ListInstancesRequest, options ...common.RetryPolicyOption) (response ListInstancesResponse, err error) {
...
func (client ComputeClient) ListShapes(ctx context.Context, request ListShapesRequest, options ...common.RetryPolicyOption) (response ListShapesResponse, err error) {
...
func (client ComputeClient) ListVnicAttachments(ctx context.Context, request ListVnicAttachmentsRequest, options ...common.RetryPolicyOption) (response ListVnicAttachmentsResponse, err error) {
...
func (client ComputeClient) ListVolumeAttachments(ctx context.Context, request ListVolumeAttachmentsRequest, options ...common.RetryPolicyOption) (response ListVolumeAttachmentsResponse, err error) {
...
func (client ComputeClient) RemoveImageShapeCompatibilityEntry(ctx context.Context, request RemoveImageShapeCompatibilityEntryRequest, options ...common.RetryPolicyOption) (err error) {
...
func (client ComputeClient) TerminateInstance(ctx context.Context, request TerminateInstanceRequest, options ...common.RetryPolicyOption) (err error) {
...
func (client ComputeClient) UpdateConsoleHistory(ctx context.Context, request UpdateConsoleHistoryRequest, options ...common.RetryPolicyOption) (response UpdateConsoleHistoryResponse, err error) {
...
func (client ComputeClient) UpdateImage(ctx context.Context, request UpdateImageRequest, options ...common.RetryPolicyOption) (response UpdateImageResponse, err error) {
...
func (client ComputeClient) UpdateInstance(ctx context.Context, request UpdateInstanceRequest, options ...common.RetryPolicyOption) (response UpdateInstanceResponse, err error) {
