...
func (client ObjectStorageClient) AbortMultipartUpload(ctx context.Context, request AbortMultipartUploadRequest, options ...common.RetryPolicyOption) (err error) {
...
func (client ObjectStorageClient) CommitMultipartUpload(ctx context.Context, request CommitMultipartUploadRequest, options ...common.RetryPolicyOption) (err error) {
...
func (client ObjectStorageClient) DeleteBucket(ctx context.Context, request DeleteBucketRequest, options ...common.RetryPolicyOption) (err error) {
...
func (client ObjectStorageClient) DeleteObject(ctx context.Context, request DeleteObjectRequest, options ...common.RetryPolicyOption) (err error) {
...
func (client ObjectStorageClient) DeletePreauthenticatedRequest(ctx context.Context, request DeletePreauthenticatedRequestRequest, options ...common.RetryPolicyOption) (err error) {
...
func (client ObjectStorageClient) HeadBucket(ctx context.Context, request HeadBucketRequest, options ...common.RetryPolicyOption) (err error) {
...
func (client ObjectStorageClient) HeadObject(ctx context.Context, request HeadObjectRequest, options ...common.RetryPolicyOption) (err error) {
...
// talk to an administrator. If you're an administrator who needs to write policies to give users access, see
// [Getting Started with Policies]({{DOC_SERVER_URL}}/Content/Identity/Concepts/policygetstarted.htm).
func (client ObjectStorageClient) PutObject(ctx context.Context, request PutObjectRequest, options ...common.RetryPolicyOption) (err error) {
...
func (client ObjectStorageClient) UploadPart(ctx context.Context, request UploadPartRequest, options ...common.RetryPolicyOption) (err error) {
